...
export default class EmployeeComponent extends Component {
  ...
  render() {
    return (
      <div>
        <div className="col-md-6 card mt-3 offset-md-3">
            ...
            <div className="card-body">
              <div className="row">
                <p><strong>Department ID: </strong>: {this.state.department.id}</p>
              </div>
              <div className="row">
            ...
            <div className="card-body">
              <div className="row">
                <p><strong>Organization ID: </strong>: {this.state.organization.id}</p>
              </div>
              <div className="row">
